...
var AuthService = (function () {
    ...
    AuthService.prototype.registerPlayer = function (player) {
        ...
        return this.http.post('http://bridgepoker.herokuapp.com/players/register', player, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getPlayers = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://bridgepoker.herokuapp.com/players', { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.registerResults = function (results, id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.put('http://bridgepoker.herokuapp.com/players/player/' + id, results, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getPlayer = function (id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://bridgepoker.herokuapp.com/players/player/' + id, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getFinal = function (id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["b" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://bridgepoker.herokuapp.com/finals/final/' + id, { headers: headers }).map(function (res) { return res.json(); });
    };
